...
def convert_abb_to_lerobot_v30(
    ...
    tasks: str = r"Pick up blocks from conveyor belt and place them in boxes"
):
    ...
    for idx, ep_data in enumerate(all_episodes):
        ...
        record = {
            **episode_metadata[ep_idx],
            'tasks': ['Pick up blocks from conveyor belt and place them in boxes'],
    ...
    df_tasks = pd.DataFrame({
        'task_index': [0],
        'task': ['Pick up blocks from conveyor belt and place them in boxes']
    })
